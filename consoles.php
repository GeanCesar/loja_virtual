...
<body>
	...
	<nav class="menu" id="me">
		...
		<div class="container">		  
			...
			<form role="form" class="form-inline" style="display: inline;"> 
			  <div class="input-group col-xs-12 col-md-12 col-lg-12 col-sm-12">
			    ...
			    <div class="input-group-btn" style="width: 1%;">
			        <button class="btn btn-default btn-Pesquisa" type="button"><i class="glyphicon glyphicon-search" ></i></button>
			    </div>
			    <!-- <datalist id="jogos">
	...
	<div class="conteudo container" id="conteudo">


		<label>Classificar: </label>
		<select class="ordem" id="ordem" name="ordem" onchange="alteraOrdem(this.value)">
      ...
      function addCarrinho(prod){
            ...
            $.ajax({            
                ...
                success: function(response) {
                	document.getElementById("bolinha").style.visibility = 'visible';
                    document.getElementById("bolinhaa").style.visibility = 'visible';
                    fechaCarrinho();
                }                
            });
       ...
       function alteraOrdem(str) {
		  ...
		  xmlhttp.open("GET","carregaConsoles.php?q="+str+"&qtdP="+qtdP,true);
		  xmlhttp.send();
		...
		$(window).scroll(function() {
		    ...
		    var elementOffset = $('footer').offset().top - 400;
