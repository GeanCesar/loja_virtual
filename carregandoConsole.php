<?php
                ...
                if(($row['Req']!="")){
                    ...
                    echo "<br><div class='collapse  col-xs-12' id='escond'>
                        <div class='col-md-12 requisitosProduto'>
                            <span class='ti'>Especificações</span>
    ...
    while($row = mysqli_fetch_array($result)) {  
            ...
            echo "
                    ...
                    <div class='tii' style='margin-bottom:0;'>";

                    if(strlen($row['Nome'])>17){
                        $nom = substr($row['Nome'], 0, 17);
                        echo "<label class='nome' style='font-weight: normal'>". $nom."... </label>";
                    }
                    else{
                        echo "<label class='nome' style='font-weight: normal'>". $row['Nome']." </label>";
                    }
                    ...
                    echo "</div>
                        ...
                        <img src='fotos/".$row['Foto']."' style='border:1px solid #07315d;'>
                        <div>
                            <label class='precoProduto'>R$ ".$row['Preco'].",00</label>
                            <div class='comprar'>
                                <a href='console.php?cod=".$row['Id']."' class='verProduto'>Ver Produto</a>   
                            </div>
